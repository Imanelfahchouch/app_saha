          ...
          <div className="col-lg-9">
            <div className="d-flex justify-content-between align-items-center mb-3">
              <span style={{ fontSize: "0.9rem", color: "var(--gray-500)" }}>
                {filteredEtablissements.length} résultat(s)
              </span>
            </div>
            ...
            {filteredEtablissements.length === 0 ? (
              ...
              <div className="row g-3">
                {filteredEtablissements.map((e, i) => (
                          ...
                          <div className="d-flex gap-3">
                            ...
                            <div className="flex-grow-1">
                              <div className="d-flex justify-content-between align-items-start">
                                ...
                                <span className={`badge ${e.etat === "ouvert" ? "bg-success-subtle text-success" : "bg-danger-subtle text-danger"} rounded-pill`} style={{ fontSize: "0.65rem" }}>
                                  {e.etat}
                                </span>
                              </div>
                              <span className={`badge ${typeBadge[e.type]} rounded-pill mb-1`} style={{ fontSize: "0.65rem" }}>
                                {typeLabels[e.type]}
                              </span>
                              ...
                              <div className="d-flex justify-content-between align-items-center mt-2">
                                ...
                                <button className="btn-details" onClick={() => openDetail(e)}>Détails</button>
                              </div>
                            </div>
                          </div>
                        </div>
